...
def train_modegan(data, g_net, d_enc, d_net, name='BEGAN',
	...
	G_sample_reg = g_net(d_enc(x0,'MODEGAN_E'),'MODEGAN_G')

	D_real = d_net(x0,'MODEGAN_D')
	D_fake = d_net(G_sample,'MODEGAN_D')
	D_reg = d_net(G_sample_reg,'MODEGAN_D')
...
perations for log/state back-up
    ...
    fig_names = ['fig_gen_{:04d}_MODEGAN.png']
    ...
    print('{:>10}, {:>7}, {:>7}, {:>7}') \
        .format('Iters', 'cur_LR', 'MODEGAN_D', 'MODEGAN_G')
